...
// Written under the consuming project's working directory, not this package's
// install location, so mappings persist alongside the project running the tool.
const MAPPINGS_DIR = path.join(process.cwd(), 'id-mappings');
