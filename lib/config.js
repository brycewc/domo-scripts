...
// Resolve config files against the project that is *running* the tool (the
// consumer's working directory), not this package's install location. This is
// what makes domo-scripts usable when installed into another project's
// node_modules. When developing inside this repo, cwd is the repo root, so the
